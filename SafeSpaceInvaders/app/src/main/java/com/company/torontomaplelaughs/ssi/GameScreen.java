...
public class GameScreen extends Screen {
    ...
    com.company.torontomaplelaughs.ssi.World world;
    ...
    public GameScreen(Game game, GameState s) {
        ...
        world=new com.company.torontomaplelaughs.ssi.World();
        mainMenuButton= com.company.torontomaplelaughs.ssi.Assets.mainMenulogo;
        fireButton= com.company.torontomaplelaughs.ssi.Assets.fireButton;
        pauseButton= com.company.torontomaplelaughs.ssi.Assets.pauseLogo;
        playerPixmap= com.company.torontomaplelaughs.ssi.Assets.playerShip;
        BackGroundPic= com.company.torontomaplelaughs.ssi.Assets.Level1_BG;
        BackGroundPic2= com.company.torontomaplelaughs.ssi.Assets.Level2_BG;
        lvl1EnimyPixmap= com.company.torontomaplelaughs.ssi.Assets.Level1_Enemy;
        lvl2EnimyPixmap= com.company.torontomaplelaughs.ssi.Assets.Level2_Enemy;
        projectilePic= com.company.torontomaplelaughs.ssi.Assets.projectile;
        healthPickup_B= com.company.torontomaplelaughs.ssi.Assets.healthPickup_B;
        SheildPickup= com.company.torontomaplelaughs.ssi.Assets.shieldPickup;
        ShotGunPickup= com.company.torontomaplelaughs.ssi.Assets.gunPickup_4;
        world.m_BgList.add(new com.company.torontomaplelaughs.ssi.BackGround(0,0));
        world.m_BgList.add(new com.company.torontomaplelaughs.ssi.BackGround(0,-BackGroundPic.getHeight()));
        world.m_BgList.add(new com.company.torontomaplelaughs.ssi.BackGround(0,-BackGroundPic.getHeight()*2));
        world.m_BgList2.add(new com.company.torontomaplelaughs.ssi.BackGround(0,0));
        world.m_BgList2.add(new com.company.torontomaplelaughs.ssi.BackGround(0,-BackGroundPic2.getHeight()));
        world.m_BgList2.add(new com.company.torontomaplelaughs.ssi.BackGround(0,-BackGroundPic2.getHeight()*2));
        random=new Random();
        state=s;
        ...
        BackGroundPic = com.company.torontomaplelaughs.ssi.Assets.Level1_BG;
        BackGroundPic2 = com.company.torontomaplelaughs.ssi.Assets.Level2_BG;
        BackGroundPic3= com.company.torontomaplelaughs.ssi.Assets.Level3_BG;
        lvl1EnimyPixmap = com.company.torontomaplelaughs.ssi.Assets.Level1_Enemy;
        lvl2EnimyPixmap = com.company.torontomaplelaughs.ssi.Assets.Level2_Enemy;
        lvl3EnimyPixmap= com.company.torontomaplelaughs.ssi.Assets.Level3_Enemy;
        projectilePic = com.company.torontomaplelaughs.ssi.Assets.projectile;
        healthPickup_B = com.company.torontomaplelaughs.ssi.Assets.healthPickup_B;
        SheildPickup = com.company.torontomaplelaughs.ssi.Assets.shieldPickup;
        ShotGunPickup = com.company.torontomaplelaughs.ssi.Assets.gunPickup_4;
        bombpickup = com.company.torontomaplelaughs.ssi.Assets.Bomb;
        world.m_BgList.add(new com.company.torontomaplelaughs.ssi.BackGround(0, 0));
        world.m_BgList.add(new com.company.torontomaplelaughs.ssi.BackGround(0, -BackGroundPic.getHeight()));
        world.m_BgList.add(new com.company.torontomaplelaughs.ssi.BackGround(0, -BackGroundPic.getHeight() * 2));
        world.m_BgList2.add(new com.company.torontomaplelaughs.ssi.BackGround(0, 0));
    ...
    public void update(float deltaTime) {
        ...
        if (state == GameState.Paused) {
            ...
            com.company.torontomaplelaughs.ssi.Settings.save(game.getFileIO());
            com.company.torontomaplelaughs.ssi.Settings.load(game.getFileIO());
        }

        if (state == GameState.GameOver) {
            game.setScreen(new com.company.torontomaplelaughs.ssi.GameOverScreen(game));
            com.company.torontomaplelaughs.ssi.Settings.save(game.getFileIO());
        }
    ...
    private void updateRunning(List<TouchEvent> touchEvents, float m_AccelX, float m_AccelY, float deltaTime) {
        //region
        if (numberOfLives <= 0) {
            com.company.torontomaplelaughs.ssi.Settings.addScore(score);
            com.company.torontomaplelaughs.ssi.Settings.save(game.getFileIO());
            state = GameState.GameOver;

            if (com.company.torontomaplelaughs.ssi.Settings.soundEnabled)
                com.company.torontomaplelaughs.ssi.Assets.DeathScreen_music.play();
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (event.type == TouchEvent.TOUCH_UP) {
                if (inBounds(event, mainMenuButtonXpos, mainMenuButtonYpos, mainMenuButton.getWidth(), mainMenuButton.getHeight() + 100)) {
                    game.setScreen(new com.company.torontomaplelaughs.ssi.MaineMenuSceen(game));
                }
                if (inBounds(event, fireButtonXpos, firButtonYpos, fireButton.getWidth(), fireButton.getHeight())) {
                    ...
                    if (com.company.torontomaplelaughs.ssi.Settings.soundEnabled = true)
                        com.company.torontomaplelaughs.ssi.Assets.gunShot_sound.play(1);

                    if (hasShotgun()) {
                        world.m_player.m_projectile.add(new com.company.torontomaplelaughs.ssi.Projectile(world.m_player.posX - 80, world.m_player.posY - 100));
                        world.m_player.m_projectile2.add(new com.company.torontomaplelaughs.ssi.Projectile(world.m_player.posX - 80, world.m_player.posY - 100));
                        world.m_player.m_projectile3.add(new com.company.torontomaplelaughs.ssi.Projectile(world.m_player.posX - 80, world.m_player.posY - 100));
                    } else {
                        world.m_player.m_projectile.add(new com.company.torontomaplelaughs.ssi.Projectile(world.m_player.posX - 80, world.m_player.posY - 100));
                    }
                }
                ...
                if (inBounds(event, pauseButtonXpos, pauseButtonYpos, pauseButton.getWidth(), pauseButton.getHeight() + 100)) {
                    game.setScreen(new com.company.torontomaplelaughs.ssi.PauseScreen(game));
                }
        ...
        if (timePassed >= puTime) {
            ...
            world.m_pickUpList.add(new com.company.torontomaplelaughs.ssi.PickUp(x, y, t, time));
            puTime += 5;
        }
        //endregion
        ...
        if (timePassed >= spawnTime) {
            if (enimyList <= maxEnimycount) {
                ...
                switch (spawnChoose) {
                    case 0:
                        world.m_EnimyList.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeA(ECA_Spawner1_PosX, ECA_Spawner1_PosY, fireRate, deltaTime, 0, 10));
                        spawnChoose++;
                        break;
                    case 1:
                        world.m_EnimyList.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeA(ECA_Spawner2_PosX, ECA_Spawner2_PosY, fireRate, deltaTime, 0, 10));
                        spawnChoose++;
                        break;
                    case 2:
                        world.m_EnimyList.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeA(ECA_Spawner3_PosX, ECA_Spawner3_PosY, fireRate, deltaTime, 10, 10));
                        spawnChoose++;
                        break;
                    case 3:
                        world.m_EnimyList.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeA(ECA_Spawner4_PosX, ECA_Spawner4_PosY, fireRate, deltaTime, -5, 2));
                        spawnChoose = 0;
                        break;
                }
            }
        ...
        for (int g = 0; g < enimyList; g++) {
            ...
            com.company.torontomaplelaughs.ssi.Enimy_TypeA curEnimy = world.m_EnimyList.get(g);
            ...
            for (int h = 0; h < projetileList; h++) {
                com.company.torontomaplelaughs.ssi.Projectile curProjectile = curEnimy.e_ProjectileList.get(h);
            ...
            if ((AxMin >= BxMin && AxMin <= BxMax || AxMax >= BxMin && AxMax <= BxMax)
                ...
                if (com.company.torontomaplelaughs.ssi.Settings.soundEnabled) {
                    com.company.torontomaplelaughs.ssi.Assets.explosion_sound.play(1);
                }
                if (hasSheild()) {
                    numSheild--;
                } else {
            ...
            for (int i = 0; i < p_project; i++) {
                com.company.torontomaplelaughs.ssi.Projectile curPprojectile = world.m_player.m_projectile.get(i);
            ...
            for (int i = 0; i < firedBulletsA; i++) {
                com.company.torontomaplelaughs.ssi.Projectile curPprojectile = world.m_player.m_projectile2.get(i);
                int p_AxMin = curPprojectile.Posx;
                int p_AyMin = curPprojectile.Posy;
                int p_AxMax = p_AxMin + (projectilePic.getWidth() / 2);
                int p_AyMax = p_AyMin + (projectilePic.getHeight() / 2);
            ...
            for (int i = 0; i < firedBulletsB; i++) {
                com.company.torontomaplelaughs.ssi.Projectile curPprojectile = world.m_player.m_projectile3.get(i);
                int p_AxMin = curPprojectile.Posx;
                int p_AyMin = curPprojectile.Posy;
                int p_AxMax = p_AxMin + (projectilePic.getWidth() / 2);
                int p_AyMax = p_AyMin + (projectilePic.getHeight() / 2);
        ...
        if (score == 500) {
            ...
            game.unlockLevel1();
            game.setScreen(new com.company.torontomaplelaughs.ssi.Level1Trans(game));
    ...
    private void updateRunningb(List<TouchEvent> touchEvents, float m_AccelX, float m_AccelY, float deltaTime) {
        ...
        if (timePassed >= spawnTime2) {
            if (enimyList <= maxEnimycount) {
                switch (spawnChoose) {
                    case 0:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner1_PosX, ECA2_Spawner1_PosY, fireRate2, deltaTime, 5, 5));
                        spawnChoose++;
                        break;
                    case 1:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner2_PosX, ECA2_Spawner2_PosY, fireRate2, deltaTime, 10, 0));
                        spawnChoose++;
                        break;
                    case 2:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner3_PosX, ECA2_Spawner3_PosY, fireRate2, deltaTime, 10, -15));
                        spawnChoose++;
                        break;
                    case 3:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner4_PosX, ECA2_Spawner4_PosY, fireRate2, deltaTime, 0, 5));
                        spawnChoose++;
                        break;
                    case 4:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner5_PosX, ECA2_Spawner5_PosY, fireRate2, deltaTime, 0, 7));
                        spawnChoose++;
                        break;
                    case 5:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner6_PosX, ECA2_Spawner6_PosY, fireRate2, deltaTime, -7, 7));
                        spawnChoose++;
                        break;
                    case 6:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner7_PosX, ECA2_Spawner7_PosY, fireRate2, deltaTime, -6, -15));
                        spawnChoose++;
                        break;
                    case 7:
                        world.m_EnimyList2.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeB(ECA2_Spawner1_PosX, ECA2_Spawner1_PosY, fireRate2, deltaTime, -3, -10));
                        spawnChoose = 0;
                        break;
                    case 8:
        ...
        int puListSize = world.m_pickUpList.size();
        for (int i = 0; i < puListSize; i++) {
            com.company.torontomaplelaughs.ssi.PickUp curPickup = world.m_pickUpList.get(i);
            int AxMin = world.m_player.posX;
            int AyMin = world.m_player.posY;
            int AxMax = AxMin + (playerPixmap.getWidth() / 2);
            int AyMax = AyMin + (playerPixmap.getHeight() / 2);
        ...
        for (int g = 0; g < enimyList; g++) {
            ...
            com.company.torontomaplelaughs.ssi.Enimy_TypeB curEnimy = world.m_EnimyList2.get(g);
            curEnimy.posX += curEnimy.SpeedX;
            curEnimy.posY += curEnimy.SpeedY;
        ...
        if (score == 1000) {
            ...
            world.m_player.m_projectile.clear();
            game.unlockLevel2();
            game.setScreen(new com.company.torontomaplelaughs.ssi.Level2Trans(game));
            state = GameState.Runningc;
        }
    ...
    private void updateRunningc(List<TouchEvent> touchEvents, float m_AccelX, float m_AccelY, float deltaTime) {
        ...
        if (timePassed >= spawnTime2) {
            if (enimyList <= maxEnimycount) {
                ...
                switch (spawnChoose) {
                    case 0:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner1_PosX, ECA2_Spawner1_PosY, fireRate2, deltaTime, 5, 5));

                        break;
                    case 1:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner2_PosX, ECA2_Spawner2_PosY, fireRate2, deltaTime, 10, 0));

                        break;
                    case 2:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner3_PosX, ECA2_Spawner3_PosY, fireRate2, deltaTime, 10, -15));

                        break;
                    case 3:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner4_PosX, ECA2_Spawner4_PosY, fireRate2, deltaTime, 0, 5));

                        break;
                    case 4:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner5_PosX, ECA2_Spawner5_PosY, fireRate2, deltaTime, 0, 7));

                        break;
                    case 5:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner6_PosX, ECA2_Spawner6_PosY, fireRate2, deltaTime, -7, 7));

                        break;
                    case 6:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner7_PosX, ECA2_Spawner7_PosY, fireRate2, deltaTime, -6, -15));

                        break;
                    case 7:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA2_Spawner1_PosX, ECA2_Spawner1_PosY, fireRate2, deltaTime, -3, -10));

                        break;
                    case 8:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA_Spawner1_PosX, ECA_Spawner1_PosY, fireRate2, deltaTime, -6, 7));
                        break;
                    case 9:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA_Spawner2_PosX, ECA_Spawner2_PosY, fireRate2, deltaTime, 0, 14));
                        break;
                    case 10:
                        world.m_EnimyList3.add(new com.company.torontomaplelaughs.ssi.Enimy_TypeC(ECA_Spawner3_PosX, ECA_Spawner3_PosY, fireRate2, deltaTime, 5, -9));
                        break;
        ...
        for (int g = 0; g < enimyList; g++) {
            ...
            com.company.torontomaplelaughs.ssi.Enimy_TypeC curEnimy = world.m_EnimyList3.get(g);
            curEnimy.posX += curEnimy.SpeedX;
            curEnimy.posY += curEnimy.SpeedY;
            //region first gameobject
            int AxMin = world.m_player.posX;
            ...
            for (int h = 0; h < projetileList2; h++) {
                com.company.torontomaplelaughs.ssi.Projectile curProjectile = curEnimy.e_ProjectileList2.get(h);
                curProjectile.Posy += eProjectileSpeedLv2 / 4;
                curProjectile.Posx += -eProjectileSpeedLv2 / 8;
                int CxMin = curProjectile.Posx;
                int CyMin = curProjectile.Posy;
            ...
            if (score == 1500) {
                ...
                world.m_player.m_projectile.clear();
                game.unlockLevel3();
                game.setScreen(new com.company.torontomaplelaughs.ssi.Level3Trans(game));
                //state=GameState.Runningb;
            }
    ...
    public void present(float deltaTime)
    {
        ...
        if(state==GameState.Running)
        {
            ...
            drawText(g, score + "", g.getWidth() / 2 - (score + "").length()*20/2, 50);
            if (numberOfLives == 3){
                g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.healthPickup_B,675,25);
                g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.healthPickup_B,675,75);
                g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.healthPickup_B,675,125);
            }
    ...
    public void drawText(Graphics g, String line, int x, int y)
    {
        ...
        for (int i = 0; i < len; i++){
            ...
            g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.numbers, x, y, srcX, 0, srcWidth, 32);

            x+= srcWidth;
        }
    }
    private void drawWorld(com.company.torontomaplelaughs.ssi.World world)
    {
        Graphics g=game.getGraphics();
        com.company.torontomaplelaughs.ssi.Player player=world.m_player;
        ...
        {
            com.company.torontomaplelaughs.ssi.BackGround newBackground=world.m_BgList.get(a);
        ...
        for (int i = 0; i < len; i++) {
            ...
            com.company.torontomaplelaughs.ssi.Projectile projectileA = world.m_player.m_projectile.get(i);
            g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.projectile, projectileA.Posx, projectileA.Posy);
        }int len2=world.m_player.m_projectile2.size();
        for (int i = 0; i < len2; i++) {

            com.company.torontomaplelaughs.ssi.Projectile projectileA = world.m_player.m_projectile2.get(i);
            g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.projectile, projectileA.Posx, projectileA.Posy);
        }
        int len3=world.m_player.m_projectile3.size();
        for (int i = 0; i < len3; i++) {

            com.company.torontomaplelaughs.ssi.Projectile projectileA = world.m_player.m_projectile3.get(i);
            g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.projectile, projectileA.Posx, projectileA.Posy);
        }
        ...
        for(int b=0;b<ben;b++)
        {
            com.company.torontomaplelaughs.ssi.Enimy_TypeA currEnimy=world.m_EnimyList.get(b);
            int ken =currEnimy.e_ProjectileList.size();
            g.drawPixmap(lvl1EnimyPixmap,currEnimy.posX,currEnimy.posY);
            for(int r=0;r<ken;r++)
            {
                com.company.torontomaplelaughs.ssi.Projectile curProjectile=currEnimy.e_ProjectileList.get(r);
                g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.projectile, curProjectile.Posx, curProjectile.Posy);
            }
        }
    ...
    private void drawWorld2(com.company.torontomaplelaughs.ssi.World world)
    {
        Graphics g=game.getGraphics();
        com.company.torontomaplelaughs.ssi.Player player=world.m_player;
        ...
        for(int a=0;a<sven;a++)
        {
            com.company.torontomaplelaughs.ssi.BackGround newBackground=world.m_BgList2.get(a);
        ...
        for(int b=0;b<ben;b++)
        {
            com.company.torontomaplelaughs.ssi.Enimy_TypeB currEnimy=world.m_EnimyList2.get(b);
            int ken =currEnimy.e_ProjectileList.size();
    ...
    private void drawWorld3(com.company.torontomaplelaughs.ssi.World world)
    {
        Graphics g=game.getGraphics();
        com.company.torontomaplelaughs.ssi.Player player=world.m_player;
        ...
        for(int b=0;b<ben;b++)
        {
            com.company.torontomaplelaughs.ssi.Enimy_TypeC currEnimy=world.m_EnimyList3.get(b);
            int ken =currEnimy.e_ProjectileList.size();
            ...
            for(int r=0;r<jen;r++)
            {
                com.company.torontomaplelaughs.ssi.Projectile curProjectile=currEnimy.e_ProjectileList2.get(r);
                g.drawPixmap(com.company.torontomaplelaughs.ssi.Assets.projectile, curProjectile.Posx, curProjectile.Posy);
            }
